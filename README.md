...
### __IMPORTANT__ the github page somehow do not always read the Latex sytax properly so consider, if you will to just clone the repo. the get all the formel.
<br>
